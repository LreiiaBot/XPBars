...
namespace XPBars
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 200, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 300, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 500, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 800, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 900, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 14000, 999, false));
            //masterBar.Subbars.Add(new XPBar("Demo1", 140, 1000, false));
            masterBar.Subbars.Add(new XPBar("Demo1", 14000, 1001, false));
            masterBar.Subbars.Add(new XPBar("Demo2", 8, 0, false));
